...
func (r *subscriptionR) GetTarget() *User {
	if r == nil {
		return nil
	}
...
func (o *Subscription) Target(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (subscriptionL) LoadTarget(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSubscription interface{}, mods queries.Applicator) error {
	var slice []*Subscription
	var object *Subscription
...
// SetTarget of the subscription to the related item.
// Sets o.R.Target to related.
// Adds o to related.R.TargetSubscriptions.
func (o *Subscription) SetTarget(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
